                    ...
                    <div class="row">
                        <div class="col-lg-9 order-1 order-lg-2">
                            ...
                            <div class="single-banner shop-page-banner">
                                <a href="#">
                                    <img src="<?=base_url()?>assets/images/bg-banner/2.jpg" alt="Li's Static Banner">
                                </a>
                            </div>
                                ...
                                <div class="tab-content">
                                    <div id="grid-view" class="tab-pane fade active show" role="tabpanel">
                                        <div class="product-area shop-product-area">
                                            <div class="row">
                                            <?php foreach($urunler as $key => $rs){?>
                                                <div class="col-lg-4 col-md-4 col-sm-6 mt-40"> 
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="single-product.html">
                                                                <img src="<?=base_url()?>uploads/urunler/<?=$rs->UrunID?>/<?=$rs->UrunResim?>" alt="Li's Product Image">
                                                            </a>
                                                            ...
                                                            <div class="product_desc_info">
                                                                <div class="product-review">
                                                                    <h5 class="manufacturer">
                                                                        <a href="product-details.html"><?=$rs->KategoriAdi?></a>
                                                                    </h5>
                                                                ...
                                                                <h4><a class="product_name" href="single-product.html"><?=$rs->Adi?></a></h4>
                                                                <div class="price-box">
                                                                    <span class="new-price"><?=$rs->Fiyat?> ₺</span>
                                                                </div>
                                                            </div>
                                                            <div class="add-actions">
                                                                <ul class="add-actions-link">
                                                                    <li class="add-cart active"><a type="button" style="cursor:pointer;" onclick="AddToCart('<?=$rs->UrunID?>')">Sepete Ekle</a></li>
