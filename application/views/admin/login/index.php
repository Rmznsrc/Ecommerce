              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Giriş yapmak için email ve şifrenizi giriniz.</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate method="POST" action="<?=base_url()?>admin/Login/girisyap">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Lütfen mail adresinizi giriniz.</div>
                      </div>
                    </div>
